                ...
                if (s.equals("castling0")) {
                    ...
                    try {
                        ...
                        if (board.moveToPosition(line, column, toLine, toColumn)) {
                            ...
                            board.printBoard();
                        } else System.out.println(board.board[line][column].getSymbol() +  board.board[line][column].getColor() + " Передвижение не удалось");
                    } catch (Exception e) {
                        System.out.println("Вы что-то ввели не так, попробуйте ещё раз: " + e.getMessage());
                    }
